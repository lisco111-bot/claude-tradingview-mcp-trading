...
3. Set environment variables in Railway dashboard:
   ...
   - **REQUIRED**: Binance API keys for live trading
4. The bot runs every 5 minutes automatically

### Railway Environment Variables

Important variables for Railway deployment:
- `PAPER_TRADING=true` for testing without real money
- `BINANCE_API_KEY`, `BINANCE_SECRET_KEY`, `BINANCE_PASSPHRASE` required for live trading
- All other parameters can be customized as needed
